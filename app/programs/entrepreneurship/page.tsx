...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://issafoundation.org/programs/entrepreneurship' },
  openGraph: { type: 'website', url: 'https://issafoundation.org/programs/entrepreneurship', title: 'Entrepreneurship Programs | ISSA Foundation', description: 'Building sustainable businesses and livelihoods across Uttarakhand.' },
