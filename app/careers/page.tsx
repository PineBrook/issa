...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://issafoundation.org/careers' },
  openGraph: {
    type: 'website',
    url: 'https://issafoundation.org/careers',
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://issafoundation.org/' },
    { '@type': 'ListItem', position: 2, name: 'Careers', item: 'https://issafoundation.org/careers' },
  ],
};
