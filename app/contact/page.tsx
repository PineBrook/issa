...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://issafoundation.org/contact' },
  openGraph: {
    type: 'website', url: 'https://issafoundation.org/contact',
...
const breadcrumbJsonLd = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Home', item: 'https://issafoundation.org/' }, { '@type': 'ListItem', position: 2, name: 'Contact', item: 'https://issafoundation.org/contact' }] };

export default function ContactPage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd) }} /><ContactView /></>;
}
